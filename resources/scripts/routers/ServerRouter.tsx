...
const ServerRouter = ({ match, location }: RouteComponentProps<{ id: string }>) => {
    ...
    return (
        ...
        <div css={tw`flex h-full min-h-screen flex-col md:flex-row`}>
          <aside css={tw`md:h-screen absolute overflow-auto bottom-0 md:top-0 flex flex-col md:flex-row`}>
          <Navigation>
          ...
          <Navigationx>
            <div css={tw`flex flex-row md:flex-col`}>
              ...
              <Can action={'database.*'}>
                  <NavLink to={`${match.url}/databases`}><FontAwesomeIcon icon={faDatabase}/></NavLink>
              </Can>
              <Can action={'startup.*'}>
